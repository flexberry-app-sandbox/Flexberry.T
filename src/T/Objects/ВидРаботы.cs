    ...
    public class ВидРаботы : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВидРаботыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидРаботыE", typeof(IIS.T.ВидРаботы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВидРаботыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидРаботыL", typeof(IIS.T.ВидРаботы));
                }
            }
        }
    }
